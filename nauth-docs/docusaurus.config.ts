    ...
    [
      'docusaurus-plugin-llms',
      {
        ...
        rootContent: [
          ...
          '- /llms-api-providers.txt — MFA, social, OIDC provider, email, SMS, database, and storage providers',
        ...
        customLLMFiles: [
          ...
          },
          {
            ...
            description:
              'MFA (TOTP, SMS, Email, Passkey), social OAuth (Google, Apple, Facebook), the OpenID Connect provider, email/SMS providers, database entities, and storage adapters.',
            orderPatterns: [
              'api/mfa/*',
              'api/social/*',
              'api/email/*',
