...
| **Social Auth** | `SOCIAL_TOKEN_INVALID`, `SOCIAL_ACCOUNT_LINKED`, `SOCIAL_ACCOUNT_NOT_FOUND`, `SOCIAL_EMAIL_REQUIRED`, `SOCIAL_CONFIG_MISSING`, `SOCIAL_ACCOUNT_EXISTS`, `SOCIAL_ACCESS_DENIED` |
...
| **OIDC Provider** | `OIDC_INTERACTION_NOT_FOUND`, `OIDC_LOGIN_REQUIRED`, `OIDC_ACCESS_DENIED` |
