...
| `recaptcha`         | `{ enabled: boolean; version: 'v2' \| 'v3' \| 'enterprise'; siteKey: string; action?: string; autoLoadScript?: boolean; language?: string }` | No       | reCAPTCHA configuration for bot protection. See [reCAPTCHA Guide](/docs/guides/recaptcha).                                                                             |
