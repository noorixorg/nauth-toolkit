...
A complete working example is available at [github.com/noorixorg/nauth/tree/main/react](https://github.com/noorixorg/nauth/tree/main/react) — React + Vite with Auth context, protected routes, Google OAuth, and challenge handling.
:::
