...
The [NestJS example](https://github.com/noorixorg/nauth/tree/main/nestjs) backend supports hybrid token delivery (cookies + JSON) out of the box — pair it with this mobile setup guide.
:::
