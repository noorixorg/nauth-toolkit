...
A complete working example is available at [github.com/noorixorg/nauth/tree/main/angular](https://github.com/noorixorg/nauth/tree/main/angular) — includes both standalone and NgModule patterns paired with the NestJS backend example.
:::
