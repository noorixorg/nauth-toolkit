...
This guide assumes you have a running nauth-toolkit backend. Complete the [NestJS](/docs/quick-start/nestjs-angular) or [Express](/docs/quick-start/express) quick start first.
:::
