...
A complete working example is available at [github.com/noorixorg/nauth/tree/main/react](https://github.com/noorixorg/nauth/tree/main/react) — React + Vite + `@nauth-toolkit/client` with Auth context, protected routes, Google OAuth, and challenge handling.
:::
...
- [React Sample App](https://github.com/noorixorg/nauth/tree/main/react) — Full working example with Google OAuth, challenge handling, and protected routes
