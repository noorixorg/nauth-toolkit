...
sidebar_position: 1
title: NestJS
description: Add authentication to a NestJS backend using nauth-toolkit
...
```bash
yarn add typeorm @nestjs/common @nestjs/core @nestjs/typeorm reflect-metadata rxjs jose pg cookie-parser
