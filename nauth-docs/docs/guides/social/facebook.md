...
:::tip Sample apps
Facebook social login is fully implemented in the [nauth example apps](https://github.com/noorixorg/nauth) — see the NestJS, Express, and Fastify examples for social routes, and the React/Angular examples for the login button and callback handling.
:::
