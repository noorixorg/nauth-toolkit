...
:::tip Sample apps
SMS MFA is configured in the [nauth example apps](https://github.com/noorixorg/nauth) using `ConsoleSMSProvider` (logs to stdout). See the NestJS, Express, and Fastify examples.
:::
