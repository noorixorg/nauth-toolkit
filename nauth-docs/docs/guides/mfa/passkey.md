...
:::tip Sample apps
Passkey MFA is fully implemented in the [nauth example apps](https://github.com/noorixorg/nauth) — see the NestJS, Express, and Fastify examples for MFA routes, and the Angular example for `passkey-setup.component.ts`.
:::
