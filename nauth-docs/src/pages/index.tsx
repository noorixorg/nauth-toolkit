...
export default function Home() {
  ...
  const jsonLd = {
    ...
    license: 'https://github.com/noorixorg/nauth-toolkit/blob/main/LICENSE',
    codeRepository: 'https://github.com/noorixorg/nauth-toolkit',
      ...
      <nav className="homepage-nav">
        <div className="nav-content">
          ...
          <div className={`nav-right ${mobileMenuOpen ? 'mobile-open' : ''}`}>
            ...
            <a
              href="https://github.com/noorixorg/nauth-toolkit"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => setMobileMenuOpen(false)}
            >
  ...
  tokenDelivery: { mode: 'cookie' },
      ...
      <section className="cta-section">
        <div className="cta-inner">
          ...
          <div className="cta-links">
            <a href="https://github.com/noorixorg/nauth-toolkit" target="_blank" rel="noopener noreferrer" className="cta-link">
      ...
      <footer className="homepage-footer">
        <div className="footer-bottom">
          ...
          <a
            href="https://github.com/noorixorg/nauth-toolkit/blob/main/LICENSE"
