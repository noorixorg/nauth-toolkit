...
| mustChangePassword → FORCE_CHANGE_PASSWORD          | WARNING: Covered in OPTIONAL | Same logic applies                                                                                     |
| mfaExempt → SUCCESS                                 | WARNING: Covered in OPTIONAL | Same logic applies                                                                                     |
...
| All other social login scenarios                               | WARNING: Partial | Core variations tested, edge cases may be missing                                                                 |
