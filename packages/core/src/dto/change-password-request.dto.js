 ...
 */
var ChangePasswordRequestDTO = function () {
    var _a;
    var _classSuper = change_password_dto_1.ChangePasswordDTO;
    var _sub_decorators;
    var _sub_initializers = [];
    var _sub_extraInitializers = [];
    return _a = /** @class */ (function (_super) {
            __extends(ChangePasswordRequestDTO, _super);
            function ChangePasswordRequestDTO() {
