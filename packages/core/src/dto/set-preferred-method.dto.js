 ...
 * DTO for setting preferred MFA method
 */
var SetPreferredMethodDTO = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function SetPreferredMethodDTO() {
                /**
 ...
 */
var SetPreferredMethodResponseDTO = /** @class */ (function () {
    function SetPreferredMethodResponseDTO() {
    }
    return SetPreferredMethodResponseDTO;
}());
