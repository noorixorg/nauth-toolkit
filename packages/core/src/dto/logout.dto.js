...
var LogoutDTO = function () {
    ...
    var _forgetMe_decorators;
    var _forgetMe_initializers = [];
    var _forgetMe_extraInitializers = [];
    return _a = /** @class */ (function () {
            function LogoutDTO() {
                 ...
                 * @example false
                 */
                this.forgetMe = (__runInitializers(this, _sub_extraInitializers), __runInitializers(this, _forgetMe_initializers, void 0));
                __runInitializers(this, _forgetMe_extraInitializers);
            }
            return LogoutDTO;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _sub_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsUUID)('4', { message: 'User sub must be a valid UUID v4 format' }), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
            ...
            _forgetMe_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsBoolean)({ message: 'forgetMe must be a boolean' })];
            ...
            __esDecorate(null, null, _forgetMe_decorators, { kind: "field", name: "forgetMe", static: false, private: false, access: { has: function (obj) { return "forgetMe" in obj; }, get: function (obj) { return obj.forgetMe; }, set: function (obj, value) { obj.forgetMe = value; } }, metadata: _metadata }, _forgetMe_initializers, _forgetMe_extraInitializers);
