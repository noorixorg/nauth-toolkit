...
var RefreshTokenDTO = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _refreshToken_decorators = [(0, class_validator_1.IsString)({ message: 'Refresh token must be a string' }), (0, class_validator_1.MinLength)(10, { message: 'Refresh token is required' }), (0, class_validator_1.MaxLength)(2048, { message: 'Refresh token must not exceed 2048 characters' })];
