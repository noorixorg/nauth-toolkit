 ...
 * DTO for getting MFA status
 */
var GetMFAStatusDTO = function () {
    var _a;
    var _sub_decorators;
    var _sub_initializers = [];
    var _sub_extraInitializers = [];
    return _a = /** @class */ (function () {
            function GetMFAStatusDTO() {
                /**
 ...
 */
var GetMFAStatusResponseDTO = /** @class */ (function () {
    function GetMFAStatusResponseDTO() {
    }
    return GetMFAStatusResponseDTO;
}());
