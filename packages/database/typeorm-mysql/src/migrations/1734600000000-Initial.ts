...
/**
 * Initial schema for nauth-toolkit (MySQL)
 *
 * @remarks
 * This file is intentionally kept in the MySQL adapter package to preserve MySQL semantics.
 *
 * IMPORTANT:
 * This migration was generated via TypeORM CLI (`migration:generate`) against an empty database
 * using the MySQL adapter entities, then normalized to the stable class name
 * `Initial1734600000000` (so the toolkit ships a predictable "ground zero" migration name).
 */
