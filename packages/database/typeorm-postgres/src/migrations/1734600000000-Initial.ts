...
/**
 * Initial schema for nauth-toolkit (PostgreSQL)
 *
 * @remarks
 * This migration is intended to be the "ground zero" schema creation for a new installation
 * on an empty database.
 *
 * It is generated/maintained in the Postgres database adapter package to ensure maximum
 * compatibility with Postgres-specific semantics (uuid generation, jsonb, timestamptz).
 */
export class Initial1734600000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Extensions
    // ============================================================================
    // Needed for uuid generation defaults (uuid_generate_v4()) used by `nauth_users.sub`.
    // Without this, a truly empty Postgres database will fail to create `nauth_users`.
    await queryRunner.query('CREATE EXTENSION IF NOT EXISTS "uuid-ossp"');

    // ============================================================================
    // CLI-aligned baseline schema
    // ============================================================================
