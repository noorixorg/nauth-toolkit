 ...
 *
 * OpenID Connect needs nothing here: `OIDCProviderModule` attaches the provider to the
 * HTTP server itself, outside Nest's routing and outside the global prefix, so
 * discovery stays at the origin root.
 */
